...
export class EnvironmentRecord {
    ...
    add(name) {
        this.variables.set(name, new JSUndefiend);
    }
    get(name) {
    ...
    set(name, value = new JSUndefiend) {
        if(this.variables.has(name)) {
...
export class ObjectEnvironmentRecord {
    ...
    add(name) {
        this.object.set(name, new JSUndefiend);
    }
    get(name) {
...
export class JSObject extends JSValue {
    ...
    setProperty(name, attributes) {
        this.peoperties.set(name,attributes);
    }
    getProperty(name) {
        return this.peoperties.get(name);
    }
    setPrototype(proto) {
...
export class JSUndefiend extends JSValue {
    toNumber() {
...
export class CompletionRecord {
    constructor(type, value, target) {
        ...
        this.value = value || new JSUndefiend;
